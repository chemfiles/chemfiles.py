...
from .ffi import c_lib, CHRP_CELL_TYPES
...
class UnitCell(object):
    ...
    def __init__(self, a, b, c, alpha=90.0, beta=90.0, gamma=90.0):
        ...
        if alpha == 90.0 and beta == 90.0 and gamma == 90.0:
            ...
            self._handle_ = c_lib.chrp_cell(a, b, c)
        else:
            self._handle_ = c_lib.chrp_cell_triclinic(
    ...
    def lengths(self):
        ...
        c_lib.chrp_cell_lengths(self._handle_, byref(a), byref(b), byref(c))
        return a.value, b.value, c.value

    def set_lengths(self, a, b, c):
        '''Set the three lenghts of an ``UnitCell``, in Angstroms.'''
        c_lib.chrp_cell_set_lengths(
    ...
    def set_periodicity(self, x, y, z):
        ...
        c_lib.chrp_cell_set_periodicity(
    ...
    def volume(self):
        ...
        V = c_double()
        c_lib.chrp_cell_volume(self._handle_, byref(V))
        return V.value
